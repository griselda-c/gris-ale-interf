...
public class ApostarPage extends WebPage{
	...
	public ApostarPage(Jugador j,AdjuntarJugadorPage mainPage){
	    ...
	    //comboApuestaw = this.getComboTipoApuesta(apuestaForm);
	    //comboJugadaw = this.getJugadas(apuestaForm);
	...
	public DropDownChoice getComboApuestaw() {
		return comboApuestaw;
	}
	...
	public DropDownChoice getComboJugadaw() {
		return comboJugadaw;
	}
	...
	public ApuestaModel getApuestaM() {
		return apuestaM;
	}

	public void setApuestaM(ApuestaModel apuestaM) {
		this.apuestaM = apuestaM;
	}
	...
	public String getFichasApuesta() {
		return fichasApuesta;
	}

	public void setFichasApuesta(String fichasApuesta) {
		this.fichasApuesta = fichasApuesta;
	}


	public String getJugadaNombre() {
		return jugadaNombre;
	}

	public void setJugadaNombre(String jugadaNombre) {
		this.jugadaNombre = jugadaNombre;
	}
